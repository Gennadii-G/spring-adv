...
INSERT INTO ROLE (id, code, name) VALUES (1, 'REGISTERED_USER', 'user');
INSERT INTO ROLE (id, code, name) VALUES (2, 'BOOKING_MANAGER', 'manager');

INSERT INTO USER (ID, NAME, EMAIL) VALUES (1, 'admin', 'somemail@mail.com')
